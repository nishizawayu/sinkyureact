    ...
    return(
        ...
        <div className=' relative'>
            <header className='w-full bg-haefwhite fixed z-[999]'>
                <div className=' w-full m-cen flex items-center lg:items-end lg:justify-around p-header-flex justify-between'>
                    <h1 className=
                    ...
                    <button onClick={handleMenuOpen} type="button" className="h-8 w-8 z-50 mr-5 relative flex flex-wrap justify-center items-center ">
                    ...
                    <div className={
                            openMenu
                                ...
                                : 'fixed z-[-100] opacity-0 top-[-50%] ease-linear duration-300'
                            }>
                        <nav className='mt-[60px] ml-[5%] text-2xl font-bold'>
                            <div>
                                <p>Top</p>
                            ...
                            <div className='mt-2'>
                                <p className=' mt-16'>Information</p>
                                <p className=' text-[14px]'>募集情報</p>
                            </div>
                        </nav>
                        <div className='absolute w-[18%] opacity-80 top-[15%] right-[20%] z-30'>
                            <div className=" w-full p-[100%] rounded-[50%] bg-[#FFD52B] blur-[8px]">
                            </div>
                        </div>
                        <div className="absolute w-[15%] top-[30%] right-[5%] z-30">
                            <div className="w-full p-[100%] rounded-[50%] bg-[#F7FF00] blur-[8px]">
                            </div>
                        </div>
                        <div className="absolute w-[25%] top-[50%] right-[30%] z-30">
